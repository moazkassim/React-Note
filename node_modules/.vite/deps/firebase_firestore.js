...
function Va(a, b2, c, d) {
  for (var e = 0; e < a.length; ++e) {
    var f = a[e];
    if (!f.ba && f.listener == b2 && f.capture == !!c && f.ha == d) return e;
  }
  return -1;
}
...
function $a(a, b2, c, d, e) {
  if (d && d.once) return ab(a, b2, c, d, e);
  if (Array.isArray(b2)) {
    for (var f = 0; f < b2.length; f++) $a(a, b2[f], c, d, e);
    return null;
  }
  c = bb(c);
...
function cb(a, b2, c, d, e, f) {
  ...
  else if (a.attachEvent) a.attachEvent(fb(b2.toString()), d);
...
function ab(a, b2, c, d, e) {
  if (Array.isArray(b2)) {
    for (var f = 0; f < b2.length; f++) ab(a, b2[f], c, d, e);
    return null;
  }
  c = bb(c);
...
function hb(a, b2, c, d, e) {
  if (Array.isArray(b2)) for (var f = 0; f < b2.length; f++) hb(a, b2[f], c, d, e);
  else (d = p(d) ? !!d.capture : !!d, c = bb(c), a && a[A]) ? (a = a.i, b2 = String(b2).toString(), b2 in a.g && (f = a.g[b2], c = Va(f, c, d, e), -1 < c && (Pa(f[c]), Array.prototype.splice.call(f, c, 1), 0 == f.length && (delete a.g[b2], a.h--)))) : a && (a = db(a)) && (b2 = a.g[b2.toString()], a = -1, b2 && (a = Va(b2, c, d, e)), (c = -1 < a ? b2[a] : null) && ib(c));
}
function ib(a) {
  if ("number" !== typeof a && a && !a.ba) {
    var b2 = a.src;
    if (b2 && b2[A]) Wa(b2.i, a);
    else {
...
function C(a, b2) {
  ...
  e = kb(h, d, true, b2) && e;
  e = kb(h, d, false, b2) && e;
  if (c) for (f = 0; f < c.length; f++) h = b2.g = c[f], e = kb(h, d, false, b2) && e;
}
      ...
      if (!(3 > r) && (3 != r || ya || this.g && (this.h.h || this.g.fa() || hc(this.g)))) {
        ...
        if (this.i) {
          if (this.Z && !this.J) {
            ...
            if (c = m) E(this.j, this.m, c, "Initial handshake response via X-HTTP-Initial-Response"), this.J = true, kc(this, c);
            else {
              this.i = false;
              this.o = 3;
              I(12);
    ...
    if (0 != c.G && (c.g == a || qc(c.h, a))) {
      if (!a.J && qc(c.h, a) && 3 == c.G) {
        ...
        if (Array.isArray(d) && 3 == d.length) {
          ...
          if (0 == e[0]) a: {
            if (!c.u) {
              if (c.g) if (c.g.F + 3e3 < a.F) rc(c), sc(c);
              else break a;
              tc(c);
              I(18);
            }
      ...
      } else if ((a.J || c.g == a) && rc(c), !pa(b2)) for (e = c.Fa.g.parse(b2), b2 = 0; b2 < e.length; b2++) {
        let m = e[b2];
        c.T = m[0];
        m = m[1];
        if (2 == c.G) if ("c" == m[0]) {
...
function Dc(a, b2) {
  ...
  else if (ba(a) || "string" === typeof a) Array.prototype.forEach.call(a, b2, void 0);
  else for (var c = Cc(a), d = Bc(a), e = d.length, f = 0; f < e; f++) b2.call(void 0, d[f], c && c[f], a);
}
...
function T(a, b2) {
  ...
  if (a instanceof T) {
    ...
    Jc(this, c);
    this.o = a.o;
  } else a && (c = String(a).match(Ec)) ? (this.h = !!b2, Gc(this, c[1] || "", true), this.s = Kc(c[2] || ""), this.g = Kc(c[3] || "", true), Hc(this, c[4]), this.l = Kc(c[5] || "", true), Jc(this, c[6] || "", true), this.o = Kc(c[7] || "")) : (this.h = !!b2, this.i = new Ic(null, this.h));
}
T.prototype.toString = function() {
  var a = [], b2 = this.j;
  b2 && a.push(Lc(b2, Mc, true), ":");
  var c = this.g;
  if (c || "file" == b2) a.push("//"), (b2 = this.s) && a.push(Lc(b2, Mc, true), "@"), a.push(encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), c = this.m, null != c && a.push(":", String(c));
  if (c = this.l) this.g && "/" != c.charAt(0) && a.push("/"), a.push(Lc(c, "/" == c.charAt(0) ? Nc : Oc, true));
...
k.W = function(a) {
  U(this);
  let b2 = [];
  if ("string" === typeof a) Uc(this, a) && (b2 = b2.concat(this.g.get(V(this, a))));
  else {
...
k.Wa = function(a) {
  if (this.g && (this.l = a, this.h || (this.status = this.l.status, this.statusText = this.l.statusText, this.h = a.headers, this.readyState = 2, hd(this)), this.g && (this.readyState = 3, hd(this), this.g))) if ("arraybuffer" === this.responseType) a.arrayBuffer().then(this.Ua.bind(this), this.ga.bind(this));
...
function Bd(a, b2) {
  if (uc(a.h) >= a.h.j - (a.m ? 1 : 0)) return false;
  if (a.m) return a.i = b2.D.concat(a.i), true;
...
function mc(a, b2) {
  ...
  if (a.g == b2) {
    ...
    a.g = null;
    var d = 2;
  } else if (qc(a.h, b2)) c = b2.D, xc(a.h, b2), d = 1;
  else return;
  if (0 != a.G) {
    if (a.pa = b2.Y, b2.i) if (1 == d) {
    ...
    else if (e = b2.o, 3 == e || 0 == e && 0 < a.pa || !(1 == d && Bd(a, b2) || 2 == d && tc(a))) switch (c && 0 < c.length && (b2 = a.h, b2.i = b2.i.concat(c)), e) {
      case 1:
        R(a, 5);
        break;
      case 4:
...
function Ad(a) {
  ...
  if (a.l) {
    const b2 = Zc(a.h);
    if (0 != b2.length || 0 != a.i.length) na(a.la, b2), na(a.la, a.i), a.h.i.length = 0, ma(a.i), a.i.length = 0;
    a.l.ua();
  }
}
function wc(a, b2, c) {
  var d = c instanceof T ? M(c) : new T(c, void 0);
  if ("" != d.g) b2 && (d.g = b2 + "." + d.g), Hc(d, d.m);
  else {
    var e = l.location;
    d = e.protocol;
...
function gc(a, b2, c) {
  if (b2 && !a.H) throw Error("Can't create secondary domain capable XhrIo object.");
...
var nt = class _nt {
   ...
   */
  constructor(t2, e) {
    if (this.seconds = t2, this.nanoseconds = e, e < 0) throw new L2(B2.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
    if (e >= 1e9) throw new L2(B2.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
    if (t2 < -62135596800) throw new L2(B2.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t2);
    if (t2 >= 253402300800) throw new L2(B2.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t2);
  }
  /**
...
var rt = class _rt extends it {
  ...
  static fromString(...t2) {
    const e = [];
    for (const n of t2) {
      if (n.indexOf("//") >= 0) throw new L2(B2.INVALID_ARGUMENT, `Invalid segment (${n}). Paths must not contain // in them.`);
...
var ut = class _ut extends it {
  ...
  static fromServerFormat(t2) {
    ...
    let n = "", s = 0;
    const i = () => {
      if (0 === n.length) throw new L2(B2.INVALID_ARGUMENT, `Invalid field path (${t2}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);
      e.push(n), n = "";
    };
    let r = false;
    for (; s < t2.length; ) {
      const e2 = t2[s];
      if ("\\" === e2) {
        if (s + 1 === t2.length) throw new L2(B2.INVALID_ARGUMENT, "Path has trailing escape character: " + t2);
        const e3 = t2[s + 1];
        if ("\\" !== e3 && "." !== e3 && "`" !== e3) throw new L2(B2.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t2);
        n += e3, s += 2;
      } else "`" === e2 ? (r = !r, s++) : "." !== e2 || r ? (n += e2, s++) : (i(), s++);
    }
    if (i(), r) throw new L2(B2.INVALID_ARGUMENT, "Unterminated ` in path: " + t2);
    return new _ut(e);
  }
  static emptyPath() {
    return new _ut([]);
...
function ft(t2, e) {
  ...
  if (0 !== n) return n;
  for (let s = 0; s < Math.min(t2.fields.length, e.fields.length); ++s) if (n = wt(t2.fields[s], e.fields[s]), 0 !== n) return n;
...
async function Et(t2) {
  if (t2.code !== B2.FAILED_PRECONDITION || t2.message !== It) throw t2;
...
var At = class _At {
  ...
  static or(t2) {
    ...
    for (const n of t2) e = e.next((t3) => t3 ? _At.resolve(t3) : n());
    return e;
  }
  static forEach(t2, e) {
    const n = [];
  ...
  async runTransaction(t2, e, n, s) {
    ...
    for (; ; ) {
      ...
      try {
        ...
        if (C2("SimpleDb", "Transaction failed with error:", e2.message, "Retrying:", n2), this.close(), !n2) return Promise.reject(e2);
      }
    }
  }
  close() {
...
var kt = class {
  ...
  st(t2, e) {
    ...
    return At.doWhile(() => true === i && s > 0, () => this.localStore.indexManager.getNextCollectionGroupToUpdate(t2).next((e2) => {
      if (null !== e2 && !n.has(e2)) return C2("IndexBackiller", `Processing collection: ${e2}`), this.it(t2, e2, s).next((t3) => {
        s -= t3, n.add(e2);
      });
      i = false;
    })).next(() => e - s);
...
function Bt(t2) {
  let e = "";
  for (let n = 0; n < t2.length; n++) e.length > 0 && (e = qt(e)), e = Lt(t2.get(n), e);
  return qt(e);
}
function Lt(t2, e) {
  let n = e;
...
function Ut(t2) {
  const e = t2.length;
  if ($(e >= 2), 2 === e) return $("" === t2.charAt(0) && "" === t2.charAt(1)), rt.emptyPath();
...
var pe = class _pe {
  ...
  removeMin() {
    if (this.left.isEmpty()) return _pe.EMPTY;
    let t2 = this;
  ...
  remove(t2, e) {
    ...
    if (e(t2, s.key) < 0) s.left.isEmpty() || s.left.isRed() || s.left.left.isRed() || (s = s.moveRedLeft()), s = s.copy(null, null, null, s.left.remove(t2, e), null);
      ...
      if (s.left.isRed() && (s = s.rotateRight()), s.right.isEmpty() || s.right.isRed() || s.right.left.isRed() || (s = s.moveRedRight()), 0 === e(t2, s.key)) {
        if (s.right.isEmpty()) return _pe.EMPTY;
  ...
  check() {
    ...
    if (t2 !== this.right.check()) throw O2();
...
var Ie = class _Ie {
  ...
  isEqual(t2) {
    if (!(t2 instanceof _Ie)) return false;
...
var Ae = class _Ae {
  ...
  unionWith(t2) {
    ...
    for (const t3 of this.fields) e = e.add(t3);
...
function Be(t2, e) {
  ...
  switch (n) {
    ...
    case 2:
      return function(t3, e2) {
        if ("integerValue" in t3 && "integerValue" in e2) return Se(t3.integerValue) === Se(e2.integerValue);
    ...
    case 10:
      return function(t3, e2) {
        ...
        if (we(n2) !== we(s)) return false;
        for (const t4 in n2) if (n2.hasOwnProperty(t4) && (void 0 === s[t4] || !Be(n2[t4], s[t4]))) return false;
        return true;
      }(t2, e);
    default:
      return O2();
...
function qe(t2, e) {
  ...
  switch (n) {
    ...
    case 10:
      return function(t3, e2) {
        if (t3 === $e.mapValue && e2 === $e.mapValue) return 0;
        if (t3 === $e.mapValue) return 1;
        if (e2 === $e.mapValue) return -1;
...
function Ue(t2, e) {
  if ("string" == typeof t2 && "string" == typeof e && t2.length === e.length) return X2(t2, e);
...
function Ge(t2) {
  return "nullValue" in t2 ? "null" : "booleanValue" in t2 ? "" + t2.booleanValue : "integerValue" in t2 ? "" + t2.integerValue : "doubleValue" in t2 ? "" + t2.doubleValue : "timestampValue" in t2 ? function(t3) {
    ...
    let e2 = "[", n2 = true;
    for (const s of t3.values || []) n2 ? n2 = false : e2 += ",", e2 += Ge(s);
    return e2 + "]";
  }(t2.arrayValue) : "mapValue" in t2 ? function(t3) {
    const e2 = Object.keys(t3.fields || {}).sort();
    let n2 = "{", s = true;
    for (const i of e2) s ? s = false : n2 += ",", n2 += `${i}:${Ge(t3.fields[i])}`;
    return n2 + "}";
  }(t2.mapValue) : O2();
  var e, n;
}
...
function Ye(t2) {
  ...
  if (t2.arrayValue) {
    ...
    for (let n = 0; n < (t2.arrayValue.values || []).length; ++n) e.arrayValue.values[n] = Ye(t2.arrayValue.values[n]);
    return e;
  }
...
var sn = class _sn {
  ...
  field(t2) {
    ...
    {
      let e = this.value;
      for (let n = 0; n < t2.length - 1; ++n) if (e = (e.mapValue.fields || {})[t2.get(n)], !Je(e)) return null;
...
function cn(t2, e, n) {
  ...
  for (let i = 0; i < t2.position.length; i++) {
    ...
    if (r.field.isKeyField()) s = ct.comparator(ct.fromName(o.referenceValue), n.key);
    else {
...
function an(t2, e) {
  ...
  if (t2.inclusive !== e.inclusive || t2.position.length !== e.position.length) return false;
  for (let n = 0; n < t2.position.length; n++) {
    if (!Be(t2.position[n], e.position[n])) return false;
  }
  return true;
}
var hn = class {
...
var wn = class _wn extends fn {
  ...
  // predicate.
  lt(t2) {
    for (const e of this.getFlattenedFilters()) if (t2(e)) return e;
    return null;
  }
};
function _n(t2) {
...
function yn(t2) {
  for (const e of t2.filters) if (e instanceof wn) return false;
  return true;
}
function pn(t2) {
  if (t2 instanceof dn)
...
function kn(t2, e) {
  ...
  for (let n = 0; n < t2.orderBy.length; n++) if (!ln(t2.orderBy[n], e.orderBy[n])) return false;
  if (t2.filters.length !== e.filters.length) return false;
  for (let n = 0; n < t2.filters.length; n++) if (!In(t2.filters[n], e.filters[n])) return false;
...
function Mn(t2, e, n) {
  ...
  if (null !== n) for (let r = 0; r < t2.orderBy.length; ++r) {
...
function zn(t2) {
  ...
  if (null === e.dt) {
    ...
    if (null !== t3 && null === n)
      ...
      let t4 = false;
      for (const n2 of e.explicitOrderBy) e.dt.push(n2), n2.field.isKeyField() && (t4 = true);
      if (!t4) {
...
function jn(t2) {
  const e = F(t2);
  if (!e.wt) if ("F" === e.limitType) e.wt = xn(e.path, e.collectionGroup, zn(e), e.filters, e.limit, e.startAt, e.endAt);
  else {
    const t3 = [];
...
function Xn(t2, e) {
  return e.isFoundDocument() && function(t3, e2) {
    ...
    */
    ...
    }(t3.startAt, zn(t3), e2)) return false;
    if (t3.endAt && !function(t4, e3, n) {
      const s = cn(t4, e3, n);
      return t4.inclusive ? s >= 0 : s > 0;
    }(t3.endAt, zn(t3), e2)) return false;
    return true;
  }(t2, e);
}
function ts(t2) {
...
var ss = class {
  ...
  set(t2, e) {
    ...
    if (void 0 === s) return this.inner[n] = [[t2, e]], void this.innerSize++;
    for (let n2 = 0; n2 < s.length; n2++) if (this.equalsFn(s[n2][0], t2))
  ...
  delete(t2) {
    ...
    for (let s = 0; s < n.length; s++) if (this.equalsFn(n[s][0], t2)) return 1 === n.length ? delete this.inner[e] : n.splice(s, 1), this.innerSize--, true;
    return false;
  }
  forEach(t2) {
    _e(this.inner, (e, n) => {
...
function us(...t2) {
  let e = os;
  for (const n of t2) e = e.insert(n.key, n);
  return e;
}
function cs(t2) {
  let e = os;
...
function bs(t2, e) {
  const n = Cs(e);
  for (const e2 of t2.elements) n.some((t3) => Be(t3, e2)) || n.push(e2);
  return {
    arrayValue: {
      values: n
    }
...
function Vs(t2, e) {
  let n = Cs(e);
  for (const e2 of t2.elements) n = n.filter((t3) => !Be(t3, e2));
  return {
    arrayValue: {
      values: n
    }
...
function Fs(t2, e) {
  if (!t2.hasLocalMutations || e && 0 === e.fields.length) return null;
  if (null === e) return t2.isNoDocument() ? new Ws(t2.key, Os.none()) : new Ks(t2.key, t2.data, Os.none());
  {
    const n = t2.data, s = sn.empty();
    let i = new Ie(ut.comparator);
    for (let t3 of e.fields) if (!i.has(t3)) {
      let e2 = n.field(t3);
...
function Ls(t2, e, n, s) {
  return t2 instanceof Ks ? function(t3, e2, n2, s2) {
    ...
    if (!$s(t3.precondition, e2)) return n2;
    const i = js(t3.fieldTransforms, s2, e2), r = e2.data;
    if (r.setAll(Qs(t3)), r.setAll(i), e2.convertToFoundDocument(e2.version, r).setHasLocalMutations(), null === n2) return null;
    return n2.unionWith(t3.fieldMask.fields).unionWith(t3.fieldTransforms.map((t4) => t4.field));
  }(t2, e, n, s) : function(t3, e2, n2) {
    if ($s(t3.precondition, e2)) return e2.convertToNoDocument(e2.version).setHasLocalMutations(), null;
    return n2;
  }(t2, e, n);
}
function qs(t2, e) {
...
var Js = class {
  ...
  applyToLocalView(t2, e) {
    for (const n of this.baseMutations) n.key.isEqual(t2.key) && (e = Ls(n, t2, e, this.localWriteTime));
    for (const n of this.mutations) n.key.isEqual(t2.key) && (e = Ls(n, t2, e, this.localWriteTime));
    return e;
  }
  /**
...
var _i = class {
   ...
   */
  Kt(t2) {
    for (const e of t2.It) t2.Tt && t2.Tt.isFoundDocument() ? this.Gt(e, t2.Tt) : this.Qt(e, t2.key, t2.Tt);
    for (const e of t2.removedTargetIds) this.Qt(e, t2.key, t2.Tt);
  }
...
function Si(t2, e) {
  const n = Pi(e);
  if (n.get(1) !== t2.databaseId.projectId) throw new L2(B2.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t2.databaseId.projectId);
  if (n.get(3) !== t2.databaseId.database) throw new L2(B2.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t2.databaseId.database);
  return new ct(Ni(n));
}
function Di(t2, e) {
...
function Fi(t2, e) {
  ...
  return e.fieldTransforms.length > 0 && (n.updateTransforms = e.fieldTransforms.map((t3) => function(t4, e2) {
    ...
    if (n2 instanceof Ps) return {
      fieldPath: e2.field.canonicalString(),
      removeAllFromArray: {
        values: n2.elements
      }
    };
    if (n2 instanceof Ss) return {
      fieldPath: e2.field.canonicalString(),
      increment: n2._t
    };
    throw O2();
...
function Bi(t2, e) {
  const n = e.currentDocument ? function(t3) {
    ...
    let n2 = null;
    if ("setToServerValue" in e3) $("REQUEST_TIME" === e3.setToServerValue), n2 = new Rs();
      ...
      n2 = new Ps(t4);
    } else "increment" in e3 ? n2 = new Ss(t3, e3.increment) : O2();
...
function Ki(t2) {
  ...
  n.where && (r = function(t3) {
    const e2 = Qi(t3);
    if (e2 instanceof wn && gn(e2)) return e2.getFilters();
    return [e2];
  }(n.where));
  let o = [];
...
function Yi(t2) {
  return t2 instanceof dn ? function(t3) {
    if ("==" === t3.op) {
      if (He(t3.value)) return {
        unaryFilter: {
          field: Hi(t3.field),
          op: "IS_NAN"
        }
      };
      if (We(t3.value)) return {
        unaryFilter: {
          field: Hi(t3.field),
          op: "IS_NULL"
        }
...
function nr(t2, e) {
  let n;
  if (e.document) n = Oi(t2.se, e.document, !!e.hasCommittedMutations);
...
function sr(t2, e) {
  ...
  if (e.isFoundDocument()) s.document = function(t3, e2) {
    return {
      name: Vi(t3, e2.key),
...
var pr = class {
  ...
  ue(t2, e) {
    if ("nullValue" in t2) this.ae(e, 5);
    else if ("booleanValue" in t2) this.ae(e, 10), e.he(t2.booleanValue ? 1 : 0);
    else if ("integerValue" in t2) this.ae(e, 15), e.he(Se(t2.integerValue));
    ...
    } else if ("stringValue" in t2) this.fe(t2.stringValue, e), this.de(e);
    else if ("bytesValue" in t2) this.ae(e, 30), e.we(De(t2.bytesValue)), this.de(e);
    else if ("referenceValue" in t2) this._e(t2.referenceValue, e);
    else if ("geoPointValue" in t2) {
      const n = t2.geoPointValue;
      this.ae(e, 45), e.he(n.latitude || 0), e.he(n.longitude || 0);
    } else "mapValue" in t2 ? Ze(t2) ? this.ae(e, Number.MAX_SAFE_INTEGER) : (this.me(t2.mapValue, e), this.de(e)) : "arrayValue" in t2 ? (this.ge(t2.arrayValue, e), this.de(e)) : O2();
  }
  fe(t2, e) {
  ...
  me(t2, e) {
    const n = t2.fields || {};
    this.ae(e, 55);
    for (const t3 of Object.keys(n)) this.fe(t3, e), this.ue(n[t3], e);
  }
  ge(t2, e) {
    const n = t2.values || [];
    this.ae(e, 50);
    for (const t3 of n) this.ue(t3, e);
  }
  _e(t2, e) {
    this.ae(e, 37);
...
var Er = class {
  ...
  be(t2) {
    for (const e of t2) {
      ...
      if (t3 < 128) this.Te(t3);
      else if (t3 < 2048) this.Te(960 | t3 >>> 6), this.Te(128 | 63 & t3);
      else if (e < "\uD800" || "\uDBFF" < e) this.Te(480 | t3 >>> 12), this.Te(128 | 63 & t3 >>> 6), this.Te(128 | 63 & t3);
      else {
  ...
  Pe(t2) {
    for (const e of t2) {
      const t3 = e.charCodeAt(0);
      if (t3 < 128) this.Re(t3);
      else if (t3 < 2048) this.Re(960 | t3 >>> 6), this.Re(128 | 63 & t3);
      else if (e < "\uD800" || "\uDBFF" < e) this.Re(480 | t3 >>> 12), this.Re(128 | 63 & t3 >>> 6), this.Re(128 | 63 & t3);
      else {
        const t4 = e.codePointAt(0);
  ...
  Ve(t2) {
    ...
    for (let t3 = e.length - n; t3 < e.length; ++t3) this.buffer[this.position++] = 255 & e[t3];
  }
  Ce(t2) {
    const e = this.Se(t2), n = Tr(e);
    this.De(1 + n), this.buffer[this.position++] = ~(255 & n);
  ...
  Se(t2) {
    ...
    e[0] ^= n ? 255 : 128;
    for (let t3 = 1; t3 < e.length; ++t3) e[t3] ^= n ? 255 : 0;
    return e;
  }
...
var Sr = class {
  ...
  Qe(t2) {
    ...
    const e = ht(t2);
    if (void 0 !== e && !this.ze(e)) return false;
    const n = lt(t2);
    let s = 0, i = 0;
    ...
    if (void 0 !== this.Ge) {
      const t3 = n[s];
      if (!this.je(this.Ge, t3) || !this.We(this.Ue[i++], t3)) return false;
      ++s;
    }
    for (; s < n.length; ++s) {
      const t3 = n[s];
      if (i >= this.Ue.length || !this.We(this.Ue[i++], t3)) return false;
    }
    return true;
  }
  ze(t2) {
    for (const e of this.Ke) if (this.je(e, t2)) return true;
    return false;
  }
  je(t2, e) {
    if (void 0 === t2 || !t2.field.isEqual(e.fieldPath)) return false;
...
function Cr(t2) {
  if (0 === t2.getFilters().length) return [];
  const e = Or(Dr(t2));
  ...
  */
  function(t3) {
    if (t3 instanceof wn && mn(t3)) {
      for (const e of t3.getFilters()) if (!xr(e) && !Nr(e)) return false;
      return true;
    }
    return false;
  }(t2);
...
function Or(t2) {
  if ($(t2 instanceof dn || t2 instanceof wn), t2 instanceof dn) return t2;
  if (1 === t2.filters.length) return Or(t2.filters[0]);
...
function $r(t2, e) {
  ...
  n = t2 instanceof dn ? e instanceof dn ? function(t3, e2) {
    ...
    if ($(t3.filters.length > 0 && e2.filters.length > 0), _n(t3) && _n(e2)) return Tn(t3, e2.getFilters());
...
var Ur = class {
      ...
      if (s) {
        ...
        return At.forEach(i, (i2, r) => {
          ...
          const u = function(t4, e2) {
            ...
            for (const e3 of $n(t4, n2.fieldPath)) switch (e3.op) {
            ...
            for (const s3 of lt(e2)) for (const e3 of $n(t4, s3.fieldPath)) switch (e3.op) {
              case "==":
              case "in":
  ...
  getIndexType(t2, e) {
    ...
    return At.forEach(s, (e2) => this.Xe(t2, e2).next((t3) => {
      t3 ? 0 !== n && t3.fields.length < function(t4) {
        ...
        for (const s2 of t4.filters) for (const t5 of s2.getFlattenedFilters())
  ...
  en(t2, e, n) {
    ...
    for (const r of lt(t2)) {
      const t3 = n[i++];
      for (const n2 of s) if (this.an(e, r.fieldPath) && je(t3)) s = this.hn(s, r, t3);
      else {
  ...
  ln(t2) {
    const e = [];
    for (let n = 0; n < t2.length; ++n) e[n] = t2[n].$e();
    return e;
  }
  /**
  ...
  hn(t2, e, n) {
    const s = [...t2], i = [];
    for (const t3 of n.arrayValue.values || []) for (const n2 of s) {
      const s2 = new vr();
  ...
  wn(t2, e) {
    ...
    if (null != i) {
      ...
      if (je(r)) for (const i2 of r.arrayValue.values || []) n = n.add(new br(e.indexId, t2.key, this.sn(i2), s));
    } else n = n.add(new br(e.indexId, t2.key, qr, s));
    return n;
  }
  /**
...
var ao = class {
  ...
  kn(t2) {
    const e = [t2, this.Nn()];
    if (this.buffer.size < this.Cn) this.buffer = this.buffer.add(e);
    else {
...
var mo = class {
  ...
  jn(t2, e, n) {
    ...
    return Io(t2).Z({
      ...
      for (; o && Ao(o, i2) < 0; ) n(o, null), o = r.getNext();
  ...
  Qn(t2, e) {
    if (e) {
      ...
      if (!(t3.isNoDocument() && t3.version.isEqual(st.min()))) return t3;
    }
...
function Ao(t2, e) {
  ...
  let i = 0;
  for (let t3 = 0; t3 < n.length - 2 && t3 < s.length - 2; ++t3) if (i = X2(n[t3], s[t3]), i) return i;
...
var vo = class {
  ...
  recalculateAndSaveOverlays(t2, e) {
    ...
    return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t2, e).next((t3) => {
      for (const i2 of t3) i2.keys().forEach((t4) => {
        const r = e.get(t4);
        if (null === r) return;
...
var Po = class {
  ...
  getOverlaysForCollectionGroup(t2, e, n, s) {
    ...
    for (; u.hasNext(); ) {
      if (u.getNext().value.forEach((t3, e2) => o.set(t3, e2)), o.size() >= s) break;
    }
    return At.resolve(o);
  }
  re(t2, e, n) {
...
var Do = class {
  ...
  addMutationBatch(t2, e, n, s) {
    ...
    for (const e2 of s) this._s = this._s.add(new So(e2.key, i)), this.indexManager.addToCollectionParentIndex(t2, e2.key.path.popLast());
    return At.resolve(r);
  }
  lookupMutationBatch(t2, e) {
...
var Lo = class _Lo {
  constructor(t2, e, n, s, i, r, o, u, c, a, h = 15) {
    ...
    this.ni = (t3) => Promise.resolve(), !_Lo.D()) throw new L2(B2.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
  ...
  oi() {
    return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (t2) => Uo(t2).put({
      ...
      if (this.isPrimary) return this.li(t2).next((t3) => {
  ...
  async gi() {
    if (this.isPrimary && !this.yi(this.ei, 18e5)) {
      ...
      if (this.ri) for (const e of t2) this.ri.removeItem(this.Ii(e.clientId));
    }
  }
  /**
  ...
  runTransaction(t2, e, n) {
    ...
    return this.ii.runTransaction(t2, s, i, (s2) => (o = new fe(s2, this.Vs ? this.Vs.next() : Ot.ct), "readwrite-primary" === e ? this.li(o).next((t3) => !!t3 || this.fi(o)).next((e2) => {
      if (!e2) throw x2(`Failed to obtain primary lease for action '${t2}'.`), this.isPrimary = false, this.Ws.enqueueRetryable(() => this.ni(false)), new L2(B2.FAILED_PRECONDITION, It);
      return n(o);
  ...
  Pi(t2) {
    return qo(t2).get("owner").next((t3) => {
      if (null !== t3 && this.yi(t3.leaseTimestampMs, 5e3) && !this.Ti(t3.ownerId) && !this._i(t3) && !(this.Js || this.allowTabSynchronization && t3.allowTabSynchronization)) throw new L2(B2.FAILED_PRECONDITION, Bo);
    });
  }
  /**
...
function Yo(t2, e) {
  ...
  return n.persistence.runTransaction("Apply remote event", "readwrite-primary", (t3) => {
    ...
    e.targetChanges.forEach((r2, u2) => {
      ...
      */
      function(t4, e2, n2) {
        if (0 === t4.resumeToken.approximateByteSize()) return true;
        if (e2.snapshotVersion.toMicroseconds() - t4.snapshotVersion.toMicroseconds() >= 3e8) return true;
...
function nu(t2, e, n) {
  ...
  return s.persistence.runTransaction("Execute query", "readonly", (t3) => function(t4, e2, n2) {
    ...
    if (e2) return i = e2.lastLimboFreeSnapshotVersion, s.Ds.getMatchingKeysForTargetId(t3, e2.targetId).next((t4) => {
      r = t4;
    });
...
async function uu(t2, e, n = ws()) {
  ...
  return i.persistence.runTransaction("Save named query", "readwrite", (t3) => {
    ...
    if (s.snapshotVersion.compareTo(r) >= 0) return i.xs.saveNamedQuery(t3, e);
...
var du = class _du {
  ...
  static Zi(t2, e) {
    ...
    for (let t3 = 0; s && t3 < n.activeTargetIds.length; ++t3) s = Ft(n.activeTargetIds[t3]), i = i.add(n.activeTargetIds[t3]);
...
var mu = class {
  ...
  async start() {
    ...
    for (const t3 of this.ur) this.ir(t3);
  ...
  ir(t2) {
    ...
    if (e.storageArea === this.storage) {
      if (C2("SharedClientState", "EVENT", e.key, e.newValue), e.key === this.cr) return void x2("Received WebStorage notification for local change. Another client might have garbage-collected our state");
  ...
  async Dr(t2) {
    if (t2.user.uid === this.currentUser.uid) return this.syncEngine.$r(t2.batchId, t2.state, t2.error);
          ...
          switch (u.getLastErrorCode()) {
            ...
            case ErrorCode.HTTP_ERROR:
              ...
              if (C2(Ru, `RPC '${t2}' ${i} failed with status:`, n2, "response text:", u.getResponseText()), n2 > 0) {
                ...
                } else o(new L2(B2.UNKNOWN, "Server responded with status " + u.getStatus()));
              } else
  ...
  wo(t2, e, n) {
    ...
    return d(a, WebChannel.EventType.OPEN, () => {
      ...
      if (!l2) {
        ...
        } else C2(Ru, `RPC '${t2}' stream ${s} received:`, i2), f.io(i2);
      }
...
var Cu = class extends Du {
  ...
  onMessage(t2) {
    ...
    const e = Mi(this.serializer, t2), n = function(t3) {
      if (!("targetChange" in t3)) return st.min();
...
var Nu = class extends class {
  ...
  nu() {
    if (this.eu) throw new L2(B2.FAILED_PRECONDITION, "The client has already been terminated.");
  }
...
async function Mu(t2) {
  if (Qu(t2)) for (const e of t2.wu) await e(
    /* enabled= */
    true
  );
}
async function Fu(t2) {
  for (const e of t2.wu) await e(
    /* enabled= */
    false
  );
}
...
async function Hu(t2, e, n) {
  ...
  else if (e instanceof li ? t2.gu.Kt(e) : e instanceof fi ? t2.gu.Jt(e) : t2.gu.zt(e), !n.isEqual(st.min())) try {
...
async function ic2(t2) {
  const e = hc2(t2);
  for (const n of t2.lu) e.Yo(n.mutations);
}
...
function fc2(t2, e) {
  if (x2("AsyncQueue", `${e}: ${t2}`), Vt(t2)) return new L2(B2.UNAVAILABLE, `${e}: ${t2}`);
  throw t2;
}
var dc2 = class _dc {
  ...
  isEqual(t2) {
    if (!(t2 instanceof _dc)) return false;
    if (this.size !== t2.size) return false;
...
var _c = class __c {
  ...
  isEqual(t2) {
    if (!(this.fromCache === t2.fromCache && this.hasCachedResults === t2.hasCachedResults && this.syncStateChanged === t2.syncStateChanged && this.mutatedKeys.isEqual(t2.mutatedKeys) && Jn(this.query, t2.query) && this.docs.isEqual(t2.docs) && this.oldDocs.isEqual(t2.oldDocs))) return false;
...
function Ic2(t2, e) {
  ...
  for (const t3 of e) {
    ...
    if (i) {
      for (const e3 of i.listeners) e3.vu(t3) && (s = true);
      i.Eu = t3;
    }
  }
  s && Ec2(n);
...
var bc2 = class {
  ...
  $u(t2) {
    ...
    if (t2.Nu.namedQuery) this.queries.push(t2.Nu.namedQuery);
    ...
    } else t2.Nu.document && (this.documents[this.documents.length - 1].document = t2.Nu.document, ++e);
  ...
  async complete() {
    ...
    for (const t3 of this.queries) await uu(this.localStore, t3, e.get(t3.name));
...
async function $c2(t2, e) {
  ...
  if (i.length > 1) return n.ic.set(s.targetId, i.filter((t3) => !Jn(t3, e))), void n.sc.delete(e);
  ...
  } else zc2(n, s.targetId), await eu(
    n.localStore,
    s.targetId,
    /*keepPersistedTargetData=*/
    true
...
function zc2(t2, e, n = null) {
  ...
  for (const s of t2.ic.get(e)) t2.sc.delete(s), n && t2.nc.wc(s, n);
...
function Wc2(t2, e, n) {
  for (const s of n) if (s instanceof Vc2) t2.cc.addReference(s.key, e), Hc2(t2, s);
...
async function sa2(t2, e) {
  ...
  if (aa2(n), ha2(n), true === e && true !== n.fc) {
    ...
    for (const t4 of e2) Bu(n.remoteStore, t4);
...
function la2(t2, e, n) {
  ...
  (async function(t3, e2, n2) {
    try {
      ...
      }(t3.localStore, s2)) return await e2.close(), n2._completeWith(function(t4) {
        return {
          taskState: "Success",
...
var wa2 = class extends da2 {
  ...
  createSharedClientState(t2) {
    const e = bu();
    if (!mu.D(e)) throw new L2(B2.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
...
var pa2 = class {
  ...
  async lookup(t2) {
    if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw new L2(B2.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
...
var Ta2 = class {
   ...
   */
  verifyNotTerminated() {
    if (this.asyncQueue.isShuttingDown) throw new L2(B2.FAILED_PRECONDITION, "The client has already been terminated.");
  }
  terminate() {
...
async function va2(t2) {
  if (!t2._offlineComponents) if (t2._uninitializedComponentsProvider) {
  ...
  } else C2("FirestoreClient", "Using default OfflineComponentProvider"), await Ea2(t2, new fa2());
...
function La2(t2, e, n, s) {
  const i = function(t3, e2) {
    ...
    return function(t4, e3) {
      ...
      if (t4 instanceof Uint8Array) return ma2(t4, e3);
      if (t4 instanceof ArrayBuffer) return ma2(new Uint8Array(t4), e3);
...
function Ga(t2, e, n) {
  if (!n) throw new L2(B2.INVALID_ARGUMENT, `Function ${t2}() cannot be called with an empty ${e}.`);
}
function Qa2(t2, e, n, s) {
  if (true === e && true === s) throw new L2(B2.INVALID_ARGUMENT, `${t2} and ${n} cannot be used together.`);
}
function za2(t2) {
  if (!ct.isDocumentKey(t2)) throw new L2(B2.INVALID_ARGUMENT, `Invalid document reference. Document references must have an even number of segments, but ${t2} has ${t2.length}.`);
}
function ja2(t2) {
  if (ct.isDocumentKey(t2)) throw new L2(B2.INVALID_ARGUMENT, `Invalid collection reference. Collection references must have an odd number of segments, but ${t2} has ${t2.length}.`);
}
function Wa2(t2) {
...
function Ha(t2, e) {
  ...
  (t2 = t2._delegate), !(t2 instanceof e)) {
    if (e.name === t2.constructor.name) throw new L2(B2.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
    {
      const n = Wa2(t2);
...
function Ja2(t2, e) {
  if (e <= 0) throw new L2(B2.INVALID_ARGUMENT, `Function ${t2}() requires a positive number, but it was: ${e}.`);
}
var Ya2 = class {
  constructor(t2) {
    var e;
    if (void 0 === t2.host) {
      if (void 0 !== t2.ssl) throw new L2(B2.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
      this.host = "firestore.googleapis.com", this.ssl = true;
    } else this.host = t2.host, this.ssl = null === (e = t2.ssl) || void 0 === e || e;
    if (this.credentials = t2.credentials, this.ignoreUndefinedProperties = !!t2.ignoreUndefinedProperties, this.cache = t2.localCache, void 0 === t2.cacheSizeBytes) this.cacheSizeBytes = 41943040;
    else {
      if (-1 !== t2.cacheSizeBytes && t2.cacheSizeBytes < 1048576) throw new L2(B2.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
...
var Za = class {
   ...
   */
  get app() {
    if (!this._app) throw new L2(B2.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
    return this._app;
  }
  get _initialized() {
  ...
  _setSettings(t2) {
    if (this._settingsFrozen) throw new L2(B2.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
...
function Xa2(t2, e, n, s = {}) {
  ...
  if ("firestore.googleapis.com" !== r.host && r.host !== e && N2("Host has been set in both settings() and useEmulator(), emulator host will be used"), t2._setSettings(Object.assign(Object.assign({}, r), {
    ...
    let e2, n2;
    if ("string" == typeof s.mockUserToken) e2 = s.mockUserToken, n2 = b.MOCK_USER;
    else {
      ...
      if (!r2) throw new L2(B2.INVALID_ARGUMENT, "mockUserToken must contain 'sub' or 'user_id' field!");
      n2 = new b(r2);
    }
...
function sh(t2, e, ...n) {
  ...
  {
    if (!(t2 instanceof th || t2 instanceof nh)) throw new L2(B2.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
...
function ih(t2, e) {
  if (t2 = Ha(t2, Za), Ga("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new L2(B2.INVALID_ARGUMENT, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
  return new eh(
    t2,
    /* converter= */
    null,
...
var ch = class {
   ...
   */
  jc(t2) {
    for (const e of this.$c) if (e.timerId === t2) return true;
    return false;
  }
  /**
  ...
  Wc(t2) {
    return this.zc().then(() => {
      ...
      for (const e of this.$c) if (e.skipDelay(), "all" !== t2 && e.timerId === t2) break;
      return this.zc();
    });
  }
  /**
...
function dh(t2, e, n) {
  ...
  if (void 0 !== e.cacheSizeBytes && void 0 !== e.localCache) throw new L2(B2.INVALID_ARGUMENT, "cache and cacheSizeBytes cannot be specified at the same time as cacheSizeBytes willbe deprecated. Instead, specify the cache size in the cache object");
  if (void 0 !== e.cacheSizeBytes && -1 !== e.cacheSizeBytes && e.cacheSizeBytes < 1048576) throw new L2(B2.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
  return s.initialize({
    options: e,
...
function gh(t2, e) {
  Ph(t2 = Ha(t2, fh));
  const n = _h(t2);
  if (n._uninitializedComponentsProvider) throw new L2(B2.FAILED_PRECONDITION, "SDK cache is already specified.");
...
function yh(t2) {
  Ph(t2 = Ha(t2, fh));
  const e = _h(t2);
  if (e._uninitializedComponentsProvider) throw new L2(B2.FAILED_PRECONDITION, "SDK cache is already specified.");
...
function Ih(t2) {
  if (t2._initialized && !t2._terminated) throw new L2(B2.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
  const e = new q2();
...
function Ph(t2) {
  if (t2._initialized || t2._terminated) throw new L2(B2.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
}
var Vh = class {
  /**
...
var Ch = class {
   ...
   */
  constructor(...t2) {
    for (let e = 0; e < t2.length; ++e) if (0 === t2[e].length) throw new L2(B2.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
...
var kh = class {
   ...
   */
  constructor(t2, e) {
    if (!isFinite(t2) || t2 < -90 || t2 > 90) throw new L2(B2.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t2);
    if (!isFinite(e) || e < -180 || e > 180) throw new L2(B2.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
...
var Bh = class _Bh {
  ...
  Jc() {
    if (this.path) for (let t2 = 0; t2 < this.path.length; t2++) this.ea(this.path.get(t2));
  }
  ea(t2) {
    if (0 === t2.length) throw this.ia("Document fields must not be empty");
    if (Fh(this.Yc) && Oh.test(t2)) throw this.ia('Document fields cannot begin and end with "__"');
  }
};
var Lh = class {
  constructor(t2, e, n) {
...
function Uh(t2, e, n, s, i, r = {}) {
  ...
  const u = Xh(s, o);
  let c, a;
  if (r.merge) c = new Ae(o.fieldMask), a = o.fieldTransforms;
  else if (r.mergeFields) {
    const t3 = [];
    for (const s2 of r.mergeFields) {
      const i2 = nl(e, s2, n);
      if (!o.contains(i2)) throw new L2(B2.INVALID_ARGUMENT, `Field '${i2}' is specified in your field mask but missing from your input data.`);
      ol(t3, i2) || t3.push(i2);
    }
...
var Kh = class _Kh extends Nh {
  _toFieldTransform(t2) {
    if (2 !== t2.Yc) throw 1 === t2.Yc ? t2.ia(`${this._methodName}() can only appear at the top level of your update data`) : t2.ia(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
function Jh(t2, e, n, s, i, r) {
  ...
  if (r.length % 2 != 0) throw new L2(B2.INVALID_ARGUMENT, `Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);
  for (let t3 = 0; t3 < r.length; t3 += 2) u.push(nl(e, r[t3])), c.push(r[t3 + 1]);
  const a = [], h = sn.empty();
  for (let t3 = u.length - 1; t3 >= 0; --t3) if (!ol(a, u[t3])) {
    const e2 = u[t3];
    let n2 = c[t3];
...
function Zh(t2, e) {
  ...
  if (t2 instanceof Nh)
    return function(t3, e2) {
      if (!Fh(e2.Yc)) throw e2.ia(`${t3._methodName}() can only be used with update() and set()`);
      if (!e2.path) throw e2.ia(`${t3._methodName}() is not currently supported inside arrays`);
  ...
  if (
    ...
    if (e.settings.ta && 4 !== e.Yc) throw e.ia("Nested arrays are not supported");
    return function(t3, e2) {
      const n = [];
      let s = 0;
      for (const i of t3) {
  ...
  return function(t3, e2) {
    ...
    if ("number" == typeof t3) return ps(e2.serializer, t3);
    ...
    if (t3 instanceof kh) return {
      geoPointValue: {
        latitude: t3.latitude,
        longitude: t3.longitude
      }
    };
    if (t3 instanceof Dh) return {
      bytesValue: Ai(e2.serializer, t3._byteString)
    };
    if (t3 instanceof th) {
      const n = e2.databaseId, s = t3.firestore._databaseId;
      if (!s.isEqual(n)) throw e2.ia(`Document reference is for database ${s.projectId}/${s.database} but should be for database ${n.projectId}/${n.database}`);
      return {
...
function nl(t2, e, n) {
  ...
  if ("string" == typeof e) return il(t2, e);
  throw rl(
...
function hl(t2) {
  if ("L" === t2.limitType && 0 === t2.explicitOrderBy.length) throw new L2(B2.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
var ll = class {
};
...
function dl(t2, e, ...n) {
  ...
  e instanceof ll && s.push(e), s = s.concat(n), function(t3) {
    ...
    if (e2 > 1 || e2 > 0 && n2 > 0) throw new L2(B2.INVALID_ARGUMENT, "InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.");
  }(s);
  for (const e2 of s) t2 = e2._apply(t2);
  return t2;
}
var wl = class _wl extends fl {
  ...
  _parse(t2) {
    const e = qh(t2.firestore), n = function(t3, e2, n2, s, i, r, o) {
      let u;
      if (i.isKeyField()) {
        if ("array-contains" === r || "array-contains-any" === r) throw new L2(B2.INVALID_ARGUMENT, `Invalid Query. You can't perform '${r}' queries on documentId().`);
        if ("in" === r || "not-in" === r) {
          xl(o, r);
          const e3 = [];
          for (const n3 of o) e3.push(Cl(s, t3, n3));
          u = {
            arrayValue: {
              values: e3
            }
      ...
      } else "in" !== r && "not-in" !== r && "array-contains-any" !== r || xl(o, r), u = Yh(
        n2,
        e2,
        o,
        /* allowArrays= */
...
var ml = class _ml extends ll {
  ...
  _apply(t2) {
    ...
    return 0 === e.getFilters().length ? t2 : (function(t3, e2) {
      ...
      for (const t4 of s) Nl(n, t4), n = Wn(n, t4);
...
var pl = class _pl extends fl {
  ...
  _apply(t2) {
    const e = function(t3, e2, n) {
      if (null !== t3.startAt) throw new L2(B2.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
      if (null !== t3.endAt) throw new L2(B2.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
      const s = new hn(e2, n);
      return function(t4, e3) {
        if (null === Kn(t4)) {
          const n2 = Gn(t4);
...
function Dl(t2, e, n, s) {
  if (n[0] = getModularInstance(n[0]), n[0] instanceof ul) return function(t3, e2, n2, s2, i) {
    if (!s2) throw new L2(B2.NOT_FOUND, `Can't use a DocumentSnapshot that doesn't exist for ${n2}().`);
    const r = [];
    for (const n3 of zn(t3)) if (n3.field.isKeyField()) r.push(Qe(e2, s2.key));
    else {
      const t4 = s2.data.field(n3.field);
      if (Ce(t4)) throw new L2(B2.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + n3.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
      if (null === t4) {
  ...
  }(t2._query, t2.firestore._databaseId, e, n[0]._document, s);
  {
    ...
    return function(t3, e2, n2, s2, i2, r) {
      ...
      if (i2.length > o.length) throw new L2(B2.INVALID_ARGUMENT, `Too many arguments provided to ${s2}(). The number of arguments must be less than or equal to the number of orderBy() clauses`);
      const u = [];
      for (let r2 = 0; r2 < i2.length; r2++) {
        const c = i2[r2];
        if (o[r2].field.isKeyField()) {
          if ("string" != typeof c) throw new L2(B2.INVALID_ARGUMENT, `Invalid query. Expected a string for document ID in ${s2}(), but got a ${typeof c}`);
          if (!Qn(t3) && -1 !== c.indexOf("/")) throw new L2(B2.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by documentId(), the value passed to ${s2}() must be a plain document ID, but '${c}' contains a slash.`);
          const n3 = t3.path.child(rt.fromString(c));
          if (!ct.isDocumentKey(n3)) throw new L2(B2.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by documentId(), the value passed to ${s2}() must result in a valid document path, but '${n3}' is not because it contains an odd number of segments.`);
          const i3 = new ct(n3);
          u.push(Qe(e2, i3));
        } else {
          const t4 = Yh(n2, s2, c);
...
function Cl(t2, e, n) {
  if ("string" == typeof (n = getModularInstance(n))) {
    if ("" === n) throw new L2(B2.INVALID_ARGUMENT, "Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");
    if (!Qn(e) && -1 !== n.indexOf("/")) throw new L2(B2.INVALID_ARGUMENT, `Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
    const s = e.path.child(rt.fromString(n));
    if (!ct.isDocumentKey(s)) throw new L2(B2.INVALID_ARGUMENT, `Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${s}' is not because it has an odd number of segments (${s.length}).`);
    return Qe(t2, new ct(s));
  }
  if (n instanceof th) return Qe(t2, n._key);
...
function xl(t2, e) {
  if (!Array.isArray(t2) || 0 === t2.length) throw new L2(B2.INVALID_ARGUMENT, `Invalid Query. A non-empty array is required for '${e.toString()}' filters.`);
}
function Nl(t2, e) {
  if (e.isInequality()) {
    const n2 = Gn(t2), s = e.field;
    if (null !== n2 && !n2.isEqual(s)) throw new L2(B2.INVALID_ARGUMENT, `Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '${n2.toString()}' and '${s.toString()}'`);
    const i = Kn(t2);
    null !== i && kl(t2, s, i);
  }
  const n = function(t3, e2) {
    for (const n2 of t3) for (const t4 of n2.getFlattenedFilters()) if (e2.indexOf(t4.op) >= 0) return t4.op;
    return null;
...
function kl(t2, e, n) {
  if (!n.isEqual(e)) throw new L2(B2.INVALID_ARGUMENT, `Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '${e.toString()}' and so you must also use '${e.toString()}' as your first argument to orderBy(), but your first orderBy() is on field '${n.toString()}' instead.`);
}
function Ol(t2, e) {
  if (!(e instanceof wl || e instanceof ml)) throw new L2(B2.INVALID_ARGUMENT, `Function ${t2}() requires AppliableConstraints created with a call to 'where(...)', 'or(...)', or 'and(...)'.`);
}
var $l = class {
...
var jl = class {
  ...
  docChanges(t2 = {}) {
    ...
    if (e && this._snapshot.excludesMetadataChanges) throw new L2(B2.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
...
function cf(t2, ...e) {
  ...
  let c, a, h;
  if (t2 instanceof th) a = Ha(t2.firestore, fh), h = qn(t2._key.path), c = {
    next: (n2) => {
      e[o] && e[o](lf(a, t2, n2));
    },
    error: e[o + 1],
...
function df(t2, e) {
  const n = Ha(t2.firestore, fh), s = _h(n), i = function(t3, e2) {
    const n2 = [];
    for (const s2 in t3) Object.prototype.hasOwnProperty.call(t3, s2) && n2.push(e2(t3[s2], s2, t3));
    return n2;
...
var Af = class {
  ...
  _verifyNotCommitted() {
    if (this._committed) throw new L2(B2.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
  }
};
function Rf(t2, e) {
  if ((t2 = getModularInstance(t2)).firestore !== e) throw new L2(B2.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
  return t2;
}
...
function bf(t2, e, n) {
  ...
  !function(t3) {
    if (t3.maxAttempts < 1) throw new L2(B2.INVALID_ARGUMENT, "Max attempts must be at least 1");
  }(s);
  return function(t3, e2, n2) {
    const s2 = new q2();
    return t3.asyncQueue.enqueueAndForget(async () => {
...
function Nf(t2, e) {
  ...
  const i = function(t3) {
    ...
    if (Array.isArray(e2.indexes)) for (const t4 of e2.indexes) {
      const e3 = kf(t4, "collectionGroup"), s2 = [];
      if (Array.isArray(t4.fields)) for (const e4 of t4.fields) {
...
function kf(t2, e) {
  if ("string" != typeof t2[e]) throw new L2(B2.INVALID_ARGUMENT, "Missing string value for: " + e);
  return t2[e];
}
!function(t2, e = true) {
  !function(t3) {
    ...
    const i = t3.getProvider("app").getImmediate(), r = new fh(new Q2(t3.getProvider("auth-internal")), new H2(t3.getProvider("app-check-internal")), function(t4, e2) {
      if (!Object.prototype.hasOwnProperty.apply(t4.options, ["projectId"])) throw new L2(B2.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
